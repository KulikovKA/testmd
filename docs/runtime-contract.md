...
Статус: реализован в TASK-002 и проверен на детерминированном тестовом двойнике и локальном `DockerRuntime` в TASK-004.
Применение контракта будущим `KataRuntime` остаётся `NOT VERIFIED` до TASK-016.
